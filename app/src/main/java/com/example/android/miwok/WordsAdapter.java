...
/**
 * Created by Daguru34 on 3/19/2017.
 */
...
public class WordsAdapter extends ArrayAdapter<Word> {
    ...
    public WordsAdapter(Activity context, ArrayList<Word> words, int colorResoureceID) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView nameTextView = (TextView) listItemView.findViewById(R.id.default_text_view2);
